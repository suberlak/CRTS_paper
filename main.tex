...
% this allows the table caption to have the same width as table 
% caption package is required alongside threeparttable for this 
% to work 
...
% comment for arxiver figure search engine
%@arxiver{Fig_2.png,Fig_3.png,Fig_4.png} 
