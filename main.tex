...
The yellow dashed line in the third panel traces the fiducial Damped Random Walk model (see eq.~\ref{eq:DRWSF}).}
\label{fig:2}
\end{figure}
...
\appendix
\section{Oscillation in the SF due to CSS calibration.} 
\label{sec:appB}
