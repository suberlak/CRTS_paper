...
with the model error $\sqrt{SF(\Delta t) ^ {2} + err_{SF} ^ {2}}$. 
...
\label{fig:CRTS_QSO_sample}
 \includegraphics[width=\columnwidth]{{Fig_4_SF_QSO_starsB_r_cut_fc-0.864-1.091-1.298}.png}
