...
We complement the CRTS data for each object  with the SDSS photometry by creating a positionally cross-matched catalog using astropy  \verb|match_to_catalog_sky| routine [matching radius distribution : describe or figure? + need to discard those few objects that had larger matching radius]. For stars we used the SDSS Stripe 82 standard stars catalog  ver. 2.6  (Ivezic+2007), and for quasars the SDSS DR7 (Abazajian+2009) stripe 82 catalog for  8974 quasars.  
