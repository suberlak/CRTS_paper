...
for timescales of about a month, while CRTS data show about a factor of two larger rms, for spectroscopically confirmed 
...
methods (SF vs. SWV, respectively): {\it here we fully reproduce this discrepancy using SF method and 
CRTS data.} 
...
\begin{figure}
\includegraphics[width=1.0\columnwidth, center]{{CRTS_stars_three_panels.png}}
...
\includegraphics[width=1.0\columnwidth, center]{{CRTS_stars_three_panels.png}}
\caption{The top panel shows the variation with magnitude of the photometric
scatter per light curve, normalized by reported CRTS photometric uncertainties (see eq.~\ref{eq:z}
for definition), using CRTS light curves for $\sim$48,000 standard (non-variable) stars from the 
\cite{ivezic2007} catalog. The middle panel shows the observed intrinsic scatter per light curve,
and the bottom panel shows the distribution of reported photometric uncertainty, both as function
of median magnitude (per light curve). 
\label{fig:CRTSerrors}} 
\end{figure}
